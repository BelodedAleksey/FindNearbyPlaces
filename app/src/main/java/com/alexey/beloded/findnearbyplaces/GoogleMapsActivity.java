package com.alexey.beloded.findnearbyplaces;
...
public class GoogleMapsActivity extends FragmentActivity implements
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googleURL.append("&key=" + "AIzaSyDu8jImiTe_Y64SU-f-y9ewsmqwnXlc0Hg");
        ...
        switch (requestCode) {
            case Request_User_Location_Code:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(GoogleMapsActivity.this, "Permission Denied...", Toast.LENGTH_SHORT).show();
                }
                return;
        }
    }
